...
<div id="box">
	<h1>This category has been updated successfully</h1>
  <div id="container">
    <a class="btn btn-default btn-lg" href="updateCategory.php" role="button">Update one more</a>
    <a class="btn btn-primary btn-lg" href="manageCategories.php" role="button">See updated categories</a>
  </div>
</div>
